...
import { FaShoppingBag, FaSeedling, FaLaptopCode, FaShippingFast, FaBriefcase } from 'react-icons/fa';
...
export default function Home() {
  return (
    ...
    <video
      ...
      src="https://videos.pexels.com/video-files/20108774/20108774-sd_640_360_25fps.mp4"
    ></video>
    ...
    <div className="relative z-10"></div>
        <Hero
          ...
          description="A multi-sector conglomerate operating in Fashion & Beauty, Agriculture & Food, Technology & Digital Solutions, Trade & Logistics, and Business Consulting & Investments."
